...
def test_in_seed_boxes_is_keyword_only():
    # The build2 ancestor took (lat, lon) positionally; the first port transposed it and 148 stations
    # silently became 0. Positional use must be a TypeError, not a wrong answer.
    from src.build3 import config
